                          ...
                          {!isAiAnalyzing && aiAnalysis && aiAnalysis.length > 0 && (
                            <div className="space-y-2">
                              <button
                                ...
                                disabled={isFixing}
                                className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-green-700 to-emerald-700 hover:from-green-600 hover:to-emerald-600 disabled:opacity-50 disabled:cursor-not-allowed text-white text-xs font-semibold px-4 py-2 rounded-lg transition-all"
                              >
                                {isFixing ? <Loader2 className="w-3 h-3 animate-spin" /> : <Zap className="w-3 h-3" />}
                                {isFixing ? 'Fixing...' : `Fix All ${aiAnalysis.length} Issues (AI)`}
                              </button>
