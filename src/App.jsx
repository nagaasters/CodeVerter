...
${sourceCode}`;
  ...
  const runAiAnalysis = async (code, language) => {
    ...
    try {
      // Confirmed working free models from OpenRouter's official list
      const FREE_MODELS = [
        'meta-llama/llama-4-maverick:free',             // #1 top free coding model
        'meta-llama/llama-4-scout:free',                // #2 large context, strong code
        'deepseek/deepseek-chat-v3-0324:free',          // #3 DeepSeek V3 confirmed free
        'deepseek/deepseek-r1-zero:free',               // #4 DeepSeek R1 Zero confirmed free
        'mistralai/mistral-small-3.1-24b-instruct:free',// #5 Mistral confirmed free
        'openrouter/quasar-alpha',                      // #6 OpenRouter's own model
        'openrouter/free',                              // #7 last resort auto-picker
      ];
