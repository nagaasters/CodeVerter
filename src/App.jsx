...
${sourceCode}`;
  ...
  const runAiAnalysis = async (code, language) => {
    ...
    setAiAnalysis(null);
    try {
      const prompt = `You are a code reviewer. Analyze this ${language} code for bugs, security issues, performance problems, and bad practices. 
Be concise. Return ONLY a JSON array of findings, no other text. Each finding must have:
- "severity": "critical" | "high" | "medium" | "low"
- "category": "security" | "runtime" | "performance" | "quality"  
- "message": short description of the issue
- "line": line number if applicable (or 0 if not)

Example: [{"severity":"high","category":"security","message":"SQL injection risk on line 5","line":5}]
